...
/* Theme state is managed by initHeaderAndNavigation. */
...
const unsupportedLucideIcons = new Set([
  "linkedin",
  "github",
  "codepen",
  "twitter"
...
document.querySelectorAll("[data-lucide]").forEach((icon) => {
  if (!unsupportedLucideIcons.has(icon.dataset.lucide)) {
    return;
  }
